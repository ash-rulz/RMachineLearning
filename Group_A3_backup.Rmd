...
ggplot(final_list$mse_df, aes(x=lambda, y = mse)) +
  ...
  ggtitle('Effect of Lambda on Training and Test error')
```
...
ggplot(data = df_final, aes(x = df, y = metric_value)) +
  ...
  ggtitle('Degrees of Freedom Vs MSE & R Squared')
print(df_final)
```
...
$$
P(Diabetes = 0) = \frac{1}{1+\exp{(-0.77962+(1.13963*x_1)+(0.29140*x_2))}}
$$
